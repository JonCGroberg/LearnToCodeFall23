...
let displayPokemonDetails = (pokemonList) => {
  ...
  for (let pokeDetails of pokemonList) {
    ...
    cardDiv.innerHTML = `<div class="large">${capitalize(
      pokeDetails.name
    )}</div>
                        <div
                            class="thumbnail"
                        ...
                        <div class="details">
                            ...
                            <div class="small">Type: ${typeStrArr.join(
                              ", "
                            )}</div>
                            <div class="small">Height: ${convertDeciToFeet(
                              pokeDetails.height
                            )}ft
                            </div>
                            <div class="small">Weight: ${convertHectoToLbs(
                              pokeDetails.weight
                            )} lbs</div>
                        </div>`;
